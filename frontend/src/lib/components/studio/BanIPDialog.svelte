...
{#if target}
  <div class="fixed inset-0 z-[90] bg-[hsl(var(--ink)/0.42)] backdrop-blur-sm" role="presentation" onclick={onClose}></div>
  <div class="fixed left-1/2 top-1/2 z-[100] w-[calc(100vw-2rem)] max-w-lg -translate-x-1/2 -translate-y-1/2 border-[3px] ink-line bg-[hsl(var(--paper))] p-5 shadow-[8px_8px_0_hsl(var(--ink))] sketch-enter" role="dialog" aria-modal="true" aria-labelledby="ban-dialog-title">
