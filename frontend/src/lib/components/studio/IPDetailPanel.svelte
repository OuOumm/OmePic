...
{#if ip}
  <div class="fixed inset-0 z-[70] grid place-items-center p-4" role="dialog" aria-modal="true" aria-labelledby="ip-detail-title" tabindex="-1" {@attach attachViewportPortal()} {@attach attachAccessibleDialog(() => ({ onClose }))}>
