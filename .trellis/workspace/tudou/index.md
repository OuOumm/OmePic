...
|---|------|-------|---------|--------|
| 18 | 2026-05-29 | 替换 gen2brain/avif 为 discord/lilliput | `5b0685d` | `main` |
| 17 | 2026-05-29 | Security remediation phases 2-4 complete | `77181d8`, `ff3e20d`, `1c5300c`, `4ddef4d` | `dev` |
| 16 | 2026-05-21 | 补充 API 页面接口示例 | `e66f690` | `main` |
| 15 | 2026-05-21 | 完成 Cloudflare 配置后台热更新 | `eff7cf5` | `main` |
